...
define("DATABASE_USER", "root"); // todo on publish saffoury_qussai
define("DATABASE_PASS", ""); //todo on publish K-O-K-Y1
...
define('DB_USER', "root"); // db user // todo on publish saffoury_qussai
define('DB_PASSWORD', ""); // db password (mention your db password here) //todo on publish K-O-K-Y1
